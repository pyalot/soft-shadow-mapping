...
lightShader = gl.shader
    ...
    '''
lightDepthTexture = gl.texture(type:'float', channels:'rgba').bind().setSize(64, 64).nearest().clampToEdge()
...
drawCamera = ->
    ...
    displayShader.use()
        ...
        .vec2('lightDepthSize', lightDepthTexture.width, lightDepthTexture.height)
